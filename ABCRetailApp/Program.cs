        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton(
                new TableStorageService<CustomerProfile>(
                    ...
                    "CustomerProfiles" // Ensure this matches your table name in Azure
                )
            );
            ...
            builder.Services.AddSingleton(
                new TableStorageService<Order>(
                    storageConnectionString,
                    "Order" // Ensure this matches your table name in Azure
                )
            );
            ...
            builder.Services.AddSingleton(serviceProvider =>
            {
                ...
                return new BlobStorageService(
                    storageConnectionString,
                    "product-images", // Ensure this matches your blob container name in Azure
                    logger
                );
            });
            ...
            builder.Services.AddSingleton(serviceProvider =>
            {
                ...
                return new FileStorageService(
                    storageConnectionString,
                    "contact-logs"// Ensure this matches your file share name in Azure
                );
            });
