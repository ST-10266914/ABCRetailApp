...
public class FilesController : Controller
{
    ...
    public async Task<IActionResult> Upload(IFormFile file)
    {
        ...
        if (file != null && file.Length > 0)
        {
            ...
            var response = await _httpClient.PostAsync("https://st10266914-poe.azurewebsites.net/api/UploadFile?code=r4lDhDfXyaHQYje0vqDB8tX94qX5vkHtiF4Isavm4_-oAzFu_A5FAQ%3D%3D", content);
